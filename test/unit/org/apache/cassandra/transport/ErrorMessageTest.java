...
{
    private static Map<VirtualEndpoint, RequestFailureReason> failureReasonMap1;
    private static Map<VirtualEndpoint, RequestFailureReason> failureReasonMap2;

    @BeforeClass
    public static void setUpFixtures() throws UnknownHostException
    {
        failureReasonMap1 = new HashMap<>();
        failureReasonMap1.put(VirtualEndpoint.getByName("127.0.0.1"), RequestFailureReason.READ_TOO_MANY_TOMBSTONES);
        failureReasonMap1.put(VirtualEndpoint.getByName("127.0.0.2"), RequestFailureReason.READ_TOO_MANY_TOMBSTONES);
        failureReasonMap1.put(VirtualEndpoint.getByName("127.0.0.3"), RequestFailureReason.UNKNOWN);

        failureReasonMap2 = new HashMap<>();
        failureReasonMap2.put(VirtualEndpoint.getByName("127.0.0.1"), RequestFailureReason.UNKNOWN);
        failureReasonMap2.put(VirtualEndpoint.getByName("127.0.0.2"), RequestFailureReason.UNKNOWN);
    }
    ...
    {
        Map<VirtualEndpoint, RequestFailureReason> modifiableFailureReasons = new HashMap<>(failureReasonMap1);
        ...
        modifiableFailureReasons.put(VirtualEndpoint.getByName("127.0.0.4"), RequestFailureReason.UNKNOWN);
