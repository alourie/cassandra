...
public class OutboundHandshakeHandlerTest
{
    ...
    private static final VirtualEndpoint localAddr = VirtualEndpoint.getByAddressOverrideDefaults(InetAddresses.forString("127.0.0.1"), 0);
    private static final VirtualEndpoint remoteAddr = VirtualEndpoint.getByAddressOverrideDefaults(InetAddresses.forString("127.0.0.2"), 0);
