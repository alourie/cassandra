...
public class ChannelWriterTest
{
    ...
    public void setup()
    {
        OutboundConnectionIdentifier id = OutboundConnectionIdentifier.small(VirtualEndpoint.getByAddressOverrideDefaults(InetAddresses.forString("127.0.0.1"), 0),
                                                                             VirtualEndpoint.getByAddressOverrideDefaults(InetAddresses.forString("127.0.0.2"), 0));
