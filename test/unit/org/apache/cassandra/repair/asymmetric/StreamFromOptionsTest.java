...
public class StreamFromOptionsTest
{
    ...
    public void addAllDiffingTest() throws UnknownHostException
    {
        ...
        Set<VirtualEndpoint> toAdd = new HashSet<>();
        toAdd.add(VirtualEndpoint.getByName("127.0.0.1"));
        toAdd.add(VirtualEndpoint.getByName("127.0.0.2"));
        toAdd.add(VirtualEndpoint.getByName("127.0.0.3"));
        ...
        Set<VirtualEndpoint> allStreams = new HashSet<>();
        for (Set<VirtualEndpoint> streams : sfo.allStreams())
        {
    ...
    private void splitTestHelper(boolean diffing) throws UnknownHostException
    {
        ...
        sfo1.add(VirtualEndpoint.getByName("127.0.0.4"));
        sfo2.add(VirtualEndpoint.getByName("127.0.0.5"));
    ...
    private static class MockDiffs extends DifferenceHolder
    {
        ...
        @Override
        public boolean hasDifferenceBetween(VirtualEndpoint node1, VirtualEndpoint node2, Range<Token> range)
        {
