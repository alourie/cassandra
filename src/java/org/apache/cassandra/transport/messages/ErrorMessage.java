                ...
                case READ_FAILURE:
                    {
                        ...
                        Map<VirtualEndpoint, RequestFailureReason> failureReasonByEndpoint = new ConcurrentHashMap<>();
                        if (version.isGreaterOrEqualTo(ProtocolVersion.V5))
                        {
                            for (int i = 0; i < failure; i++)
                            {
                                ...
                                failureReasonByEndpoint.put(VirtualEndpoint.getByAddress(endpoint), failureReason);
                            }
                        }
                ...
                case READ_FAILURE:
                    {
                        ...
                        if (version.isGreaterOrEqualTo(ProtocolVersion.V5))
                        {
                            for (Map.Entry<VirtualEndpoint, RequestFailureReason> entry : rfe.failureReasonByEndpoint.entrySet())
                            {
