...
public class RowIteratorMergeListener implements UnfilteredRowIterators.MergeListener
{
    ...
    public RowIteratorMergeListener(DecoratedKey partitionKey, RegularAndStaticColumns columns, boolean isReversed, VirtualEndpoint[] sources, ReadCommand command, RepairListener repairListener)
    {
