...
public class BlockingReadRepair implements ReadRepair, RepairListener
{
    ...
    private final List<VirtualEndpoint> endpoints;
    ...
    public BlockingReadRepair(ReadCommand command,
                              List<VirtualEndpoint> endpoints,
    ...
    public UnfilteredPartitionIterators.MergeListener getMergeListener(VirtualEndpoint[] endpoints)
    {
    ...
    public static class BlockingPartitionRepair extends AbstractFuture<Object> implements RepairListener.PartitionRepair
    {
        ...
        protected AsyncOneResponse sendMutation(VirtualEndpoint endpoint, Mutation mutation)
        {
        ...
        public void reportMutation(VirtualEndpoint endpoint, Mutation mutation)
        {
    ...
    public void startForegroundRepair(DigestResolver digestResolver, List<VirtualEndpoint> allEndpoints, List<VirtualEndpoint> contactedEndpoints, Consumer<PartitionIterator> resultConsumer)
    {
        ...
        for (VirtualEndpoint endpoint : contactedEndpoints)
        {
