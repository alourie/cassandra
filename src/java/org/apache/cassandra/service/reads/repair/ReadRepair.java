...
public interface ReadRepair
{
     ...
     */
    UnfilteredPartitionIterators.MergeListener getMergeListener(VirtualEndpoint[] endpoints);
    ...
    public void startForegroundRepair(DigestResolver digestResolver,
                                      List<VirtualEndpoint> allEndpoints,
                                      List<VirtualEndpoint> contactedEndpoints,
    ...
    static ReadRepair create(ReadCommand command, List<VirtualEndpoint> endpoints, long queryStartNanoTime, ConsistencyLevel consistency)
    {
