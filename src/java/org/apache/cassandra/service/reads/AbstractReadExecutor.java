...
public abstract class AbstractReadExecutor
{
    ...
    AbstractReadExecutor(Keyspace keyspace, ColumnFamilyStore cfs, ReadCommand command, ConsistencyLevel consistency, List<VirtualEndpoint> targetReplicas, long queryStartNanoTime)
    {
     ...
     */
    public abstract List<VirtualEndpoint> getContactedReplicas();
    ...
    public static class NeverSpeculatingReadExecutor extends AbstractReadExecutor
    {
        ...
        public List<VirtualEndpoint> getContactedReplicas()
        {
