...
public abstract class AbstractWriteResponseHandler<T> implements IAsyncCallbackWithFailure<T>
{
    ...
    protected final Collection<VirtualEndpoint> naturalEndpoints;
    public final ConsistencyLevel consistencyLevel;
    protected final Runnable callback;
    protected final Collection<VirtualEndpoint> pendingEndpoints;
    ...
    protected AbstractWriteResponseHandler(Keyspace keyspace,
                                           Collection<VirtualEndpoint> naturalEndpoints,
     ...
     */
    protected boolean waitingFor(VirtualEndpoint from)
    {
        return true;
    }
