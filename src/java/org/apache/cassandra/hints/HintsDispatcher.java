...
final class HintsDispatcher implements AutoCloseable
{
    ...
    private HintsDispatcher(HintsReader reader, UUID hostId, VirtualEndpoint address, int messagingVersion, BooleanSupplier abortRequested)
    {
    ...
    static HintsDispatcher create(File file, RateLimiter rateLimiter, VirtualEndpoint address, UUID hostId, BooleanSupplier abortRequested)
    {
