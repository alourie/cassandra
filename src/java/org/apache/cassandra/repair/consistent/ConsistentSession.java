 ...
 *  First, the normal {@link ActiveRepairService#prepareForRepair(UUID, VirtualEndpoint, Set, RepairOption, List)} stuff
 ...
 *  to {@code FAILED}.
 *  <p/>
 *  (see {@link LocalSessions#handlePrepareMessage(VirtualEndpoint, PrepareConsistentRequest)}
 *  <p/>
 ...
 *  <p/>
 *
 *  On the local session side, see {@link LocalSessions#handleFinalizeProposeMessage(VirtualEndpoint, FinalizePropose)}
 *  & {@link LocalSessions#handleFinalizeCommitMessage(VirtualEndpoint, FinalizeCommit)}
 *
 * <h1>Failure</h1>
...
public abstract class ConsistentSession
{
    ...
    public final ImmutableSet<VirtualEndpoint> participants;
    ...
    abstract static class AbstractBuilder
    {
        ...
        void withCoordinator(VirtualEndpoint coordinator)
        {
        ...
        void withParticipants(Set<VirtualEndpoint> peers)
        {
