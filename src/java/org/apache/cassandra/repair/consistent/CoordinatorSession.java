...
public class CoordinatorSession extends ConsistentSession
{
    ...
    private final Map<VirtualEndpoint, State> participantStates = new HashMap<>();
    ...
    public synchronized void setParticipantState(VirtualEndpoint participant, State state)
    {
    ...
    public ListenableFuture<Boolean> prepare()
    {
        ...
        for (final VirtualEndpoint participant : participants)
        {
