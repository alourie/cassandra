...
{
    public AsymmetricRemoteSyncTask(RepairJobDesc desc, VirtualEndpoint fetchNode, VirtualEndpoint fetchFrom, List<Range<Token>> rangesToFetch, PreviewKind previewKind)
    {
