...
public abstract class AsymmetricSyncTask extends AbstractFuture<SyncStat> implements Runnable
{
    ...
    protected final VirtualEndpoint fetchFrom;
    protected final List<Range<Token>> rangesToFetch;
    protected final VirtualEndpoint fetchingNode;
    protected final PreviewKind previewKind;
    private long startTime = Long.MIN_VALUE;
    protected volatile SyncStat stat;


    public AsymmetricSyncTask(RepairJobDesc desc, VirtualEndpoint fetchingNode, VirtualEndpoint fetchFrom, List<Range<Token>> rangesToFetch, PreviewKind previewKind)
    {
        this.desc = desc;
