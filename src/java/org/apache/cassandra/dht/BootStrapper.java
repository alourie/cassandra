...
public class BootStrapper extends ProgressEventNotifierSupport
{
    ...
    protected final VirtualEndpoint address;
    /* token of the node being bootstrapped. */
    protected final Collection<Token> tokens;
    protected final TokenMetadata tokenMetadata;

    public BootStrapper(VirtualEndpoint address, Collection<Token> tokens, TokenMetadata tmd)
    {
        assert address != null;
     ...
     */
    public static Collection<Token> getBootstrapTokens(final TokenMetadata metadata, VirtualEndpoint address, int schemaWaitDelay) throws ConfigurationException
    {
                                            ...
                                            int schemaWaitDelay)
    {
        ...
        if (!FBUtilities.getBroadcastAddressAndPort().equals(VirtualEndpoint.getLoopbackAddress()))
