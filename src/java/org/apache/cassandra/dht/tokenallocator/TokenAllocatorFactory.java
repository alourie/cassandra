...
public class TokenAllocatorFactory
{
    ...
    public static TokenAllocator<VirtualEndpoint> createTokenAllocator(NavigableMap<Token, VirtualEndpoint> sortedTokens,
                                                                       ReplicationStrategy<VirtualEndpoint> strategy,
