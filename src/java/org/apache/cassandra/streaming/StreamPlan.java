...
public class StreamPlan
{
     ...
     */
    public StreamPlan requestRanges(VirtualEndpoint from, VirtualEndpoint connecting, String keyspace, Collection<Range<Token>> ranges)
    {
     ...
     * @return this object for chaining
     */
    public StreamPlan requestRanges(VirtualEndpoint from, VirtualEndpoint connecting, String keyspace, Collection<Range<Token>> ranges, String... columnFamilies)
    {
     ...
     *
     * @see #transferRanges(VirtualEndpoint, VirtualEndpoint, String, java.util.Collection, String...)
     */
    public StreamPlan transferRanges(VirtualEndpoint to, String keyspace, Collection<Range<Token>> ranges, String... columnFamilies)
    {
     ...
     * @return this object for chaining
     */
    public StreamPlan transferRanges(VirtualEndpoint to, VirtualEndpoint connecting, String keyspace, Collection<Range<Token>> ranges)
    {
     ...
     * @return this object for chaining
     */
    public StreamPlan transferRanges(VirtualEndpoint to, VirtualEndpoint connecting, String keyspace, Collection<Range<Token>> ranges, String... columnFamilies)
    {
     ...
     * @return this object for chaining
     */
    public StreamPlan transferFiles(VirtualEndpoint to, Collection<StreamSession.SSTableStreamingSections> sstableDetails)
    {
