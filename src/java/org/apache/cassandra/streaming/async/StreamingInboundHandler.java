...
public class StreamingInboundHandler extends ChannelInboundHandlerAdapter
{
    ...
    private final VirtualEndpoint remoteAddress;
    ...
    public StreamingInboundHandler(VirtualEndpoint remoteAddress, int protocolVersion, @Nullable StreamSession session)
    {
    ...
    {
        final VirtualEndpoint from;
        final UUID planId;
        final int sessionIndex;

        SessionIdentifier(VirtualEndpoint from, UUID planId, int sessionIndex)
        {
            this.from = from;
            this.planId = planId;
