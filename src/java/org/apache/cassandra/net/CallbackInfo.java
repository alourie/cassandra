...
{
    protected final VirtualEndpoint target;
     ...
     */
    public CallbackInfo(VirtualEndpoint target, IAsyncCallback callback, IVersionedSerializer<?> serializer, boolean failureCallback)
    {
        this.target = target;
