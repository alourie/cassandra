...
public class PropertyFileSnitch extends AbstractNetworkTopologySnitch
{
    ...
    private static volatile Map<VirtualEndpoint, String[]> endpointMap;
     ...
     */
    public static String[] getEndpointInfo(VirtualEndpoint endpoint)
    {
    ...
    private static String[] getRawEndpointInfo(VirtualEndpoint endpoint)
    {
    ...
    {
        HashMap<VirtualEndpoint, String[]> reloadedMap = new HashMap<>();
        ...
        for (Map.Entry<Object, Object> entry : properties.entrySet())
        {
            ...
            else
            {
                ...
                try
                {
                    host = VirtualEndpoint.getByName(hostString);
                }
        ...
        VirtualEndpoint localAddress = FBUtilities.getLocalAddressAndPort();
        ...
        if (logger.isTraceEnabled())
        {
            ...
            for (Map.Entry<VirtualEndpoint, String[]> entry : reloadedMap.entrySet())
     ...
     */
    private static boolean livenessCheck(HashMap<VirtualEndpoint, String[]> reloadedMap, String[] reloadedDefaultDCRack)
    {
        ...
        Set<VirtualEndpoint> hosts = Arrays.equals(defaultDCRack, reloadedDefaultDCRack)
